...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 관리자 코드 수정 전용 스타일 생성
    cssManager.addStyle('admin-code-edit', `
        .admin-code-edit-page .code-edit-container {
            opacity: 0;
            transform: translateY(20px);
            transition: all var(--transition-normal);
        }

        .admin-code-edit-page .code-edit-container.loaded {
            opacity: 1;
            transform: translateY(0);
        }

        .admin-code-edit-page .form-card {
        ...
        .admin-code-edit-page .form-group {
            margin-bottom: var(--space-lg);
        }

        .admin-code-edit-page .form-label {
            display: block;
            font-weight: 600;
        ...
        .admin-code-edit-page .form-input,
        .admin-code-edit-page .form-select {
            width: 100%;
        ...
        .admin-code-edit-page .form-input:focus,
        .admin-code-edit-page .form-select:focus {
            outline: none;
            border-color: var(--color-primary);
            box-shadow: 0 0 0 2px rgba(34, 40, 49, 0.1);
        }

        .admin-code-edit-page .form-input.error {
            border-color: var(--color-error);
            box-shadow: 0 0 0 2px rgba(0, 0, 0, 0.1);
        }

        .admin-code-edit-page .form-input.success {
            border-color: var(--color-success);
            box-shadow: 0 0 0 2px rgba(34, 40, 49, 0.1);
        }

        .admin-code-edit-page .duplicate-check-section {
        ...
        .admin-code-edit-page .check-result {
            margin-top: var(--space-sm);
            font-size: var(--font-size-sm);
        }

        .admin-code-edit-page .check-result .success {
            color: var(--color-success);
        }

        .admin-code-edit-page .check-result .error {
            color: var(--color-error);
        }

        .admin-code-edit-page .preview-section {
            background: var(--color-light-gray);
            border: 1px solid var(--color-border);
            border-radius: var(--radius-md);
            padding: var(--space-md);
        ...
        .admin-code-edit-page .preview-item {
            display: flex;
        ...
        .admin-code-edit-page .preview-item:last-child {
            border-bottom: none;
        }

        .admin-code-edit-page .preview-label {
            font-weight: 600;
            color: var(--color-text);
            min-width: 100px;
        }

        .admin-code-edit-page .preview-value {
            color: var(--color-text-secondary);
            flex: 1;
            text-align: right;
        }

        .admin-code-edit-page .form-actions {
            display: flex;
            gap: var(--space-sm);
        ...
        .admin-code-edit-page .btn--submit {
            background: var(--color-primary);
            color: var(--color-white);
        }

        .admin-code-edit-page .btn--cancel {
            background: var(--color-secondary);
            color: var(--color-white);
        }

        .admin-code-edit-page .loading-overlay {
            position: fixed;
            top: 0;
            left: 0;
            width: 100%;
        ...
        .admin-code-edit-page .loading-spinner {
            width: 40px;
            height: 40px;
    ...
    function initializeFormEvents() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            if ((originalGcode !== gcodeField.value || originalCode !== codeField.value) && !isDuplicateChecked) {
                notify.warning('코드값이 변경되었습니다. 중복 확인을 먼저 진행해주세요.', '중복 확인 필요');
                return;
            }
    ...
    async function submitForm() {
        ...
        try {
            ...
            if (data.code === '00') {
                notify.success('코드가 성공적으로 수정되었습니다.', '수정 완료');
                setTimeout(() => {
                ...
                if (data.code === '01' && data.details && data.details.fieldErrors) {
                    ...
                    notify.error(data.message || '코드 수정 중 오류가 발생했습니다.', '수정 오류');
                }
            }
        } catch (error) {
            console.error('Error:', error);
    ...
    function animatePageLoad() {
        const container = document.querySelector('.code-edit-container');
        if (container) {
            setTimeout(() => {
