...
import com.kh.demo.web.page.form.board.DetailForm;
import com.kh.demo.web.page.form.board.ReplyForm;
import com.kh.demo.web.page.form.board.SaveForm;
import com.kh.demo.web.page.form.board.UpdateForm;
...
public class BoardController extends BaseController {
    ...
    public String addForm(Model model, HttpSession session) {
        ...
        if (loginMemberObj instanceof com.kh.demo.web.page.form.login.LoginMember loginMember) {
    ...
    public String delete(@PathVariable Long id, RedirectAttributes redirectAttributes, HttpSession session) {
        ...
        com.kh.demo.web.page.form.login.LoginMember loginMember =
