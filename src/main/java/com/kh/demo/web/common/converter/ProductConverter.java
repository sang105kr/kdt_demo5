package com.kh.demo.web.common.converter;
...
public class ProductConverter {
     ...
     */
    public Products toEntity(CreateRequest request) {
     ...
     */
    public Products toEntity(UpdateRequest request) {
        Products product = new Products();
        BeanUtils.copyProperties(request, product);
        // Long → Integer 타입 변환
        if (request.getPrice() != null) {
     ...
     */
    public ReadResponse toResponse(Products product) {
     ...
     */
    public List<ReadResponse> toResponseList(List<Products> products) {
     ...
     */
    public void updateEntity(Products existingProduct, UpdateRequest request) {
