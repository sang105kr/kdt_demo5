package com.kh.demo.web.common.validator;
...
public class ProductValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return CreateRequest.class.equals(clazz) || UpdateRequest.class.equals(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        if (target instanceof CreateRequest) {
            validateCreateRequest((CreateRequest) target, errors);
        } else if (target instanceof UpdateRequest) {
            validateUpdateRequest((UpdateRequest) target, errors);
        }
    }
     ...
     * 상품 등록 요청 검증
     */
    private void validateCreateRequest(CreateRequest request, Errors errors) {
     ...
     * 상품 수정 요청 검증
     */
    private void validateUpdateRequest(UpdateRequest request, Errors errors) {
        Locale locale = LocaleContextHolder.getLocale();
