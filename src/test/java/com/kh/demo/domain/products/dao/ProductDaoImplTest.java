...
class ProductDaoImplTest {
    ...
    void findAllWithPaging() {
        ...
        // When
        List<Products> productsList = productDao.findAll(pageNo, numOfRows);
    ...
    void findById() {
        ...
        // When
        Optional<Products> foundProduct = productDao.findById(productId);
    ...
    void findByIdNotFound() {
        ...
        // When
        Optional<Products> foundProduct = productDao.findById(nonExistentId);
    ...
    void updateById() {
        ...
        // When
        int updatedRows = productDao.updateById(productId, updateData);

        // Then
        Assertions.assertThat(updatedRows).isEqualTo(1);
        
        // 수정된 데이터 확인
        Optional<Products> updatedProduct = productDao.findById(productId);
    ...
    void deleteById() {
        ...
        // 삭제 확인
        Optional<Products> deletedProduct = productDao.findById(productId);
    ...
    void saveAndGetTotalCount() {
        ...
        Long productId = productDao.save(newProduct);
        int afterSaveCount = productDao.getTotalCount();
